    ...
    public class AccountController : BaseController
    {
        ...
        public ActionResult Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    WebSecurity.CreateUserAndAccount(model.UserName, model.Password, new{model.FirstName, model.LastName, model.PhoneNumber});

                    //Add user to the "viewer" role
